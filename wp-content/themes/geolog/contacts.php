...
<div class="content">
    ...
    <section class="section-page-contacts">
        <div class="container">
            <div class="section-page-contacts-row">
                <!-- col-->
                <div class="section-page-contacts-row__col">
                    <?php
                    if(get_field('phone_link', 'option') && get_field('phone_front', 'option')) {
                    ?>
                    <!--item-->
                    <div class="section-page-contacts-row__item section-page-contacts-row-item">
                        <div class="section-page-contacts-row__name">
                            Телефон:
                        </div>
                        <div class="section-page-contacts-row__val">
                    ...
                    <div class="section-page-contacts-row__item section-page-contacts-row-item">
                        ...
                        <div class="section-page-contacts-row__val">
                            <ul>
                                <li>9:00-18:00 (будни)</li>
                                <li>Субб-Воск (выходные) </li>

                            </ul>
                        </div>
                    </div>
                    <!--socials-->
                    <div class="section-page-contacts-row-item__socials">
                        <?php 
                        ...
                        <a href="<?php echo get_field('ssylka_telegram', 'option'); ?>">
                            <svg width="33" height="33" viewBox="0 0 33 33" fill="none"
                                ...
                                <rect width="33" height="33" rx="16.5" fill="url(#paint0_linear_82_416)" />
                                <path
                                    ...
                                    fill="white" />
                                <defs>
                                    <linearGradient id="paint0_linear_82_416" x1="16.5" y1="0" x2="16.5"
    ...
    <section class="section-form" id="callback">
        <div class="container">
            <div class="callback-form">
                ...
                <?php 
                set_query_var( 'form_name', 'contacts_form' );
                set_query_var( 'form_id', 'contacts_form' );
